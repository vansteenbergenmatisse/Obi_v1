...
| `0.3-code-vs-design-audit-2026-09-14/` | one synopsis per code folder, auditing the code against the design page at a pinned commit (substep 0.3.1). Frozen snapshot. See its own README. | substep 0.3.1 (obi-auditor runs) |
| `0.3-synopsis-2026-09-16/` | the test-suite inventory and infrastructure inventory for substep 0.3.2/0.3.3 (`test-suite-inventory.md`, `infrastructure-inventory.md`). Frozen snapshot at that date. | substep 0.3.2/0.3.3 (obi-auditor runs) |
