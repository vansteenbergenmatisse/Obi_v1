...
the repo-root `config/` (not nested under `backend`) so it reads as one global place
regardless of which app you're looking at — `frontend` can read the same file later (e.g. the
