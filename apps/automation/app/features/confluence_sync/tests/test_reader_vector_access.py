...
from app.platform.db.models import EMB_DIM, KIND_CHILD, Chunk, Document, DocumentVersion, PageSource
...
# in app/platform/db/tests/test_models_indexes.py's test_r2_indexes_hnsw_uses_hnsw_method_..., which
