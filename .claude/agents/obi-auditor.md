...
hooks:
  PreToolUse:
    - matcher: "Bash|Write|Edit|MultiEdit|NotebookEdit"
      hooks:
        - type: command
          command: python3 "$CLAUDE_PROJECT_DIR/backend/tools/agent_guard.py" auditor
---
...
Read design panels with `python3 backend/tools/panel.py <id>`. Never open the design page or the brief in full.
